...
In Teleoscope, we load embedding models from the **[Hugging Face](https://huggingface.co/) Hub**—in production this is **[BAAI/bge-m3](https://huggingface.co/BAAI/bge-m3)** via **[FlagEmbedding](https://github.com/FlagOpen/FlagEmbedding)**—which captures nuanced semantic similarity. These models are good for categorical and paraphrase-style relationships because they were trained on huge amounts of text. 
...
or in our minds, which may not be captured by the chosen embedding model.
Teleoscope is model-agnostic: you can point the vectorizer at another Hugging Face embedding model and re-vectorize when needed.


### The Teleoscope Ranking Tool
The eponymous Teleoscope tool ranks documents by similarity using those dense embeddings. 
...
toward your specific way of thinking about your document set.
