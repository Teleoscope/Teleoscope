...
const demoText = "Ready to see Teleoscope first hand? Schedule a demo with our team to discover how Teleoscope can empower your team.";
  ...
  return (
    <div className="flex justify-center items-center w-full gap-8 py-60 relative overflow-hidden ">
       ...
       <Image
        ...
        <div className="flex justify-center items-center absolute  overflow-visible w-full ">
      ...
      <div className="flex flex-col gap-8   max-w-xl rounded-xl w-full p-10 px-20 z-10">
        ...
        <div className="flex items-center justify-center p-4">
          <a href={demoCTAHref} target="_blank" rel="noreferrer" className="bg-primary hover:bg-secondary text-white rounded-full p-2 px-4 font-medium hover:bg-primary-600">
           Book a demo
          </a>
        </div>
      </div>
