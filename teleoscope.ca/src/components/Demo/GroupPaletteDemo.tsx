...
import { addGroup, removeGroup, relabelGroup, recolorGroup } from "@/actions/appState";
import { useSWRF } from "@/lib/swr";

// custom components
export default function GroupsDemo(props) {
  
  const { data: sessions } = useSWRF(`sessions/`);
  const { data: users } = useSWRF(`users/`);
