    ...
    return (
      <div className="flex justify-center w-screen h-screen ">
        ...
        <Sidebar sidebarOptions={sidebarOptions} haveSections={false}>
            ...
            height={18}
          />
             <span className="text-xl  w-full font-semibold">Teleoscope</span>
          
            </div>
            <div className="w-full px-1  rounded-xl   py-1">
            <input type="text" placeholder="Search" className="px-2 h-9 w-full border bg-transparent rounded-lg text-sm from-zinc-50 to-white bg-gradient-to-t " />
            </div>
            </div>
        </Sidebar>
