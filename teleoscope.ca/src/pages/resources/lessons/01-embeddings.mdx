...
That overlaps with our intuition that "The dog napped in the park" and "The dog napped in the park" 
...
## Why Teleoscope uses Hugging Face embedding models

In Teleoscope, we load open models from the **[Hugging Face](https://huggingface.co/) Hub**—by default **[BAAI/bge-m3](https://huggingface.co/BAAI/bge-m3)** through **[FlagEmbedding](https://github.com/FlagOpen/FlagEmbedding)**—which capture rich semantic similarity. These models are strong on categorical and paraphrase-style relationships because they were trained on large text corpora.
...
Teleoscope is model-agnostic at the architecture level: swap the vectorizer for another Hugging Face–compatible embedding model and re-vectorize if you need different behavior.