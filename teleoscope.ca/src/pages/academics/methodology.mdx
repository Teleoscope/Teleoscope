...
We use **pre-trained transformer embedding models** from the **[Hugging Face](https://huggingface.co/)** ecosystem (see [BAAI/bge-m3](https://huggingface.co/BAAI/bge-m3) in production) to provide
dense vectors for your documents, then apply a variety of techniques to help you find and group documents
...
qualitative researchers front-and-center. We wanted to reflect the process of arranging data by hand 
...
Although Teleoscope relies on a fixed embedding model for efficiency, you impose your own interpretive perspective by 
asking the system to rank and group documents according to what you think is similar. Ideally, it is picking
...
to reflect an underlying intuition that you have about your data, and help reflect the way that you 
...
the groups you provide. You can think of it like steering a general-purpose embedding model
(such as the one Teleoscope uses for document vectors) toward your specific way of thinking about your document set.